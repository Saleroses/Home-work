...
function Clock() {
    ...
    const stringDay = new Intl.DateTimeFormat('en-US', {weekday: 'long'}).format() || <br/> // пишут студенты
    const stringMonth = new Intl.DateTimeFormat('en-US', {month: 'long'}).format() || <br/> // пишут студенты
